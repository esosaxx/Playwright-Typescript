...
test.describe("Remove Product", () => {
    ...
    test("Remove a product from the cart and verify it is no longer listed", async ({page}) => {
        ...
        await expect(page.locator(productPage.basketItem, {hasText: "Sauce Labs Backpack"})).not.toBeVisible()
    })
})
