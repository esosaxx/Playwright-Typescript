...
test.describe("Checkout", () => {
  ...
  test("Complete the checkout process successfully", async ({ page }) => {
    ...
    await expect(page.locator(checkoutConfirmedPage.title)).toHaveText(
      "Checkout: Complete!",
    );
    await expect(page.locator(checkoutConfirmedPage.header)).toHaveText(
      "Thank you for your order!",
    );
    await expect(page.locator(checkoutConfirmedPage.completionText)).toHaveText(
